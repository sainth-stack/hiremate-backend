...
TEMPLATES: list[ResumeTemplate] = [
    ...
    },
    {
        ...
        "category": "modern",
        "ats_score": 94,
        "best_for": ["tech", "product", "startup", "design"],
        "premium": False,
        "layout": "single_column",
        "description": "Bold accent colour on section headings for a polished look.",
        "fonts": ["Arial", "Helvetica", "Calibri", "Lato", "Segoe UI"],
        "color_schemes": [
            {"id": "blue",    "label": "Blue",    "primary": "#1e3a5f", "accent": "#1e3a5f", "bg": "#ffffff"},
            {"id": "teal",    "label": "Teal",    "primary": "#0f4c5c", "accent": "#0f766e", "bg": "#ffffff"},
            {"id": "indigo",  "label": "Indigo",  "primary": "#1e1b4b", "accent": "#6366f1", "bg": "#ffffff"},
        ],
    },
    {
        "id": "minimalist",
