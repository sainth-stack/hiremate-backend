...
function getWidgetHTML() {
  return `
    ...
    <div class="ja-card">
      <div class="ja-head" id="ja-drag-handle">
        ...
        <button type="button" class="ja-head-btn" id="ja-open-settings" title="Settings">
  ...
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round">
    ...
    <line x1="6" y1="6" x2="18" y2="18"></line>
      ...
      <div class="ja-settings-panel" id="ja-settings-panel" style="display:none">
        <div class="ja-settings-head">
          <button type="button" class="ja-settings-back-btn" id="ja-settings-back">
        ...
        <div class="ja-settings-body">
          ...
          <div class="ja-settings-row">
            <div class="ja-settings-row-info">
              <div class="ja-settings-row-label">Cold Message Mode</div>
              <div class="ja-settings-row-desc">AI-draft cold messages on LinkedIn compose boxes</div>
            </div>
            <label class="hm-toggle">
              <input type="checkbox" id="hm-cold-toggle" />
